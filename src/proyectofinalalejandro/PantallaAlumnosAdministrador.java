...
public class PantallaAlumnosAdministrador extends javax.swing.JFrame {
  ...
  public void registrarUsuario(JTextField nombreTEXT, JTextField ApellidoTEXT, JTextField correoTEXT, JTextField contraTEXT) {
    ...
    ///////////////////////////////////////////////////////////
  public void cargarDatosAlumno(Connection con) {
    try {
        int filaSeleccionada = TablaAlumnos.getSelectedRow();
        if (filaSeleccionada != -1) {
            String idSeleccionado = TablaAlumnos.getValueAt(filaSeleccionada, 0).toString();
  ...
  ////////////////////////////////////////////////////
  public void editarAlumno(Connection con, JTextField nombreTEXT, JTextField ApellidoTEXT, JTextField correoTEXT, JTextField contraTEXT) {
    String nombre = nombreTEXT.getText();
    String apellido = ApellidoTEXT.getText();
    String correo = correoTEXT.getText();
    String clave = contraTEXT.getText();
